...
LightningDefineType(WindowTabEvent, builder, type)
{
}

LightningDefineType(HighlightBorderEvent, builder, type)
{
}

LightningDefineType(TabModifiedEvent, builder, type)
{
}

LightningDefineType(TabRenamedEvent, builder, type)
{
}

LightningDefineType(QueryModifiedSaveEvent, builder, type)
{
}
...
LightningDefineType(TabArea, builder, type)
{
}
...
{
  // Erase will return previous valid element or plasma
...
LightningDefineType(Window, builder, type)
{
}
...
Window* GetWindowContaining(Widget* widget)
{
  ...
  BoundType* windowType = LightningTypeId(Window);

  while (widget != nullptr)
  {
    if (LightningVirtualTypeId(widget) == windowType)
